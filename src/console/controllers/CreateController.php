 ...
 *
 * ./craft db-snapshot/create
 *
 * Actions must be in 'kebab-case' so actionDoSomething() maps to 'do-something',
 * and would be invoked via:
 *
 * ./craft db-snapshot/create/do-something
 *
 * @author    Josh Butts
 * @package   DbSnapshot
 * @since     1.0.0
...
class CreateController extends Controller
{
    ...
    /**
     * Handle db-snapshot/create console commands
     *
    ...
    public function actionIndex()
    {
        ...
        echo "Welcome to the console CreateController actionIndex() method\n";

        return $result;
    }

    /**
     * Handle db-snapshot/create/do-something console commands
     *
     * The first line of this method docblock is displayed as the description
     * of the Console Command in ./craft help
     *
    ...
    public function actionDoSomething()
    {
        ...
        echo "Welcome to the console CreateController actionDoSomething() method\n";
