...
/**
 * DB Snapshot config.php
 *
 * This file exists only as a template for the DB Snapshot settings.
 * It does nothing on its own.
 *
 * Don't edit this file, instead copy it to 'craft/config' as 'db-snapshot.php'
